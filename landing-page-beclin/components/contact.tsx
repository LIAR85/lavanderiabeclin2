        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:items-start">
          <div id="contacto" className="scroll-mt-24">
            ...
            <p className="mt-4 max-w-md text-lg leading-relaxed text-muted-foreground text-pretty">
              Pasa a dejar tu ropa o escríbenos para resolver cualquier duda.
            ...
            <ul className="mt-8 space-y-4">
              <li className="flex items-start gap-4">
                ...
                <div>
                  <p className="font-heading text-base font-black text-primary">Dirección</p>
              ...
              <li className="flex items-start gap-4">
                ...
                <div>
                  <p className="font-heading text-base font-black text-primary">Teléfono</p>
                  <a
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Button
                asChild
                size="lg"
                className="rounded-full bg-[#25D366] font-bold text-white shadow-md shadow-[#25D366]/25 hover:bg-[#20bd5a]"
              >
                <a
          ...
          <div className="overflow-hidden rounded-3xl border border-border bg-card shadow-lg">
            <iframe
              title="Ubicación de beclin en Plaza Sierra Madre, Ciudad Victoria"
              src={mapSrc}
