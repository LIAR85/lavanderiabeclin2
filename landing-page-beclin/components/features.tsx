...
const features = [
  {
    ...
    description: 'Años de experiencia lavando y planchando cada tipo de prenda.',
  },
  {
    icon: HandHeart,
  ...
  {
    icon: Truck,
    title: 'Fácil y cerca de ti',
    description: 'Ubicados en Plaza Sierra Madre, en el corazón de Ciudad Victoria.',
  },
]
    ...
    <section id="porque" className="scroll-mt-24 bg-primary py-20 text-primary-foreground sm:py-24">
      <div className="mx-auto w-full max-w-6xl px-4 sm:px-6">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-3 font-heading text-3xl font-black tracking-tight text-balance sm:text-4xl">
        ...
        <div className="mt-14 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {features.map((feature) => (
            ...
            >
              ...
              <h3 className="mt-5 font-heading text-lg font-black">{feature.title}</h3>
